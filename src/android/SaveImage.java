...
public class SaveImage extends CordovaPlugin {
    ...
    private void saveImageToGallery(JSONArray args, CallbackContext callback) throws JSONException {
    	...
    	this.myDir = args.getString(1);
      this.fileName = args.getString(2);
      this.extension = args.getString(3);
        ...
        if (PermissionHelper.hasPermission(this, WRITE_EXTERNAL_STORAGE)) {
			...
			performImageSave(myDir, fileName, extension);
     ...
     */
    private void performImageSave(String myDir, String fileName, String extension) throws JSONException {
        // create file from passed path
        File srcFile = new File(filePath);

        // destination gallery folder - external storage
	    //if(myDir == null || myDir.equals("")){
	    	File dstGalleryFolder = Environment.getExternalStoragePublicDirectory(myDir);
	    //}else{
        ...
        try {
            ...
            File expFile = copyFile(srcFile, dstGalleryFolder, fileName, extension);
     ...
     */
    private File copyFile(File srcFile, File dstFolder, String fileName, String extension) {
        ...
        File newFile = new File(dstFolder.getPath() + File.separator + fileName + extension);
