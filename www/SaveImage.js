...
ImageSaver.saveImageToGallery = function (localImagePath, fileName, extension, customDir, successCallback, failureCallback) {
    ...
    return cordova.exec(
        successCallback, failureCallback, 'SaveImage', 'saveImageToGallery', [_getLocalImagePathWithoutPrefix(),customDir, fileName, extension]);
